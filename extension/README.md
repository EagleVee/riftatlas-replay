...
Built so far: the **shared core** and the **player**. The recorder (main-world
observer, content bridge, service worker) is phase 3 and not written yet —
`main-world/`, `content/`, `background/` and `popup/` are placeholders.
